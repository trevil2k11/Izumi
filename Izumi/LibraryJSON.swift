...
class LibraryJSON {
    ...
    func returnAddComment(_ login: String, pic_id: String, rating: String, comment: String) -> String {
        return "{'controller':'comments','action':'addcomment','login':'" + login + "','pic_id':'" + pic_id + "','rating':'" + rating + "','comm':'" + comment + "'}";
    }
    ...
    func returnFullURL(_ part: String) -> String {
        return "http://trevilre.bget.ru/api" + part
    }
