...
class MainStylistProfile: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    fileprivate let reuseIdenifier = "PortfolioCell"
